  ...
  return (
    ...
    >
      <CardContent className="p-8 relative overflow-hidden">
        ...
        {/* Logo */}
        <div className="w-40 h-40 rounded-2xl bg-white/10 backdrop-blur-sm p-6 mb-6 group-hover:scale-110 transition-transform duration-300 flex items-center justify-center">
          {logo ? (
            <img 
              src={logo} 
              alt={logoAlt || title} 
